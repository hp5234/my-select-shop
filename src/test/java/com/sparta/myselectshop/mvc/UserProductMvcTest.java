...
class UserProductMvcTest {
    ...
    private MockMvc mvc; // MVC 객체

    private Principal mockPrincipal; // 테스트에서 사용될 인증용 객체
    ...
    @BeforeEach
    public void setup() {
        // MVC 객체 세팅 시 테스트를 위해 만든 테스트용 필터를 springSecurity 에 설정한다.
